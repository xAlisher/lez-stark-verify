...
| cost | **~1–3 s** | **two real proofs, ~19 min** (measured 2026-08-24, 16 cores) · ~9.6 GB peak |
...
on-chain truth; it's **infrequent and non-blocking**, so the ~19 min (two proofs, and it scales
...
- **Prove-side vs verify-side split** — the heavy proving (**~9.5 min / ~9.6 GB per proof**, two per
